...
function exportIcons()
{
    ...
    sketchtool export slices "$SKETCH_PATH" --output="$ICONS_DIR" --formats="png" --scales="0.5"
    sketchtool export slices "$SKETCH_PATH" --output="$ICONS_DIR" --formats="png" --scales="1"
    sketchtool export slices "$SKETCH_PATH" --output="$ICONS_DIR" --formats="png" --scales="1.5"
